...
#p.show()
p.grid()
p.savefig('../plots/s11_CST_vs_ReflectometryRich_TallCylinderGapOverDish_Delay_filterZero.pdf',bbox_inches='tight')
p.close()
...
#p.show()
p.grid()
p.savefig('../plots/s11_CST_vs_ReflectometryRich_TallCylinderGapOverDish_Frequency_filterZero.pdf',bbox_inches='tight')
p.close()
