...
#p.show()
p.grid()
p.savefig('../plots/s11_CST_vs_ReflectometryRich_TallCylinderGapOverDish_Delay_filterNegative.pdf',bbox_inches='tight')
p.close()
...
#p.show()
p.grid()
p.savefig('../plots/s11_CST_vs_ReflectometryRich_TallCylinderGapOverDish_Frequency_filterNegative.pdf',bbox_inches='tight')
p.close()
